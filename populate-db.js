...
const catagoryCreate = (name, description, cb) => {
  catagoryInfo = { name, description };
  catagory = new Catagory(catagoryInfo);
...
const plantCreate = (name, description, catagory, price, stock, cb) => {
  plantInfo = { name, description, catagory, price, stock };
